...
public final class AppModule_ProvideprefFileName$app_debugFactory implements Factory<String> {
  ...
  public static String provideInstance(AppModule module) {
    return proxyProvideprefFileName$app_debug(module);
  }
  ...
  public static String proxyProvideprefFileName$app_debug(AppModule instance) {
    return Preconditions.checkNotNull(
        instance.provideprefFileName$app_debug(),
